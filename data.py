...
# Populate weekly adjusted stock data dictionary
for weeklyadj_csv_file in weeklyadj_csv_files:
    ...
    # Store the data in weeklyadj_stock_data_dict with the symbol as the key
...
# Populate sector stock data dictionary
for sector_csv_file in sector_csv_files:
    ...
    # Store the data in sector_stock_data_dict with the symbol as the key
...
# Populate SMP (Stock Market Performance) data dictionary
for smp_csv_file in smp_csv_files:
    ...
    # Store the data in smp_data_dict with the symbol as the key
...
# Create a dictionary from the NASDAQ DataFrame
...
us_data = {
    ...
    "UEM": {"name": "US Unemployment rate", "title": "US Unemployment rate", "unit": "percent"},
