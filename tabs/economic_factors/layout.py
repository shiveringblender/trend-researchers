...
def get_layout():
    return html.Div([
                ...
                html.P(" 1. Gross Domestic Product (GDP) Growth: GDP is a fundamental indicator that quantifies the overall economic output of a nation. Examining its relationship \
                ...
                html.P(" 2. Unemployment Rates: The unemployment rate reflects the percentage of the labor force without employment and actively\
                ...
                html.P(" 3. Inflation Rates: Inflation rates represent the rate at which the general price level of goods\
                ...
                html.P(" The economic indicator data was as well as the S&P500 data collected over the Alpha Vantage  API, but those are originally \
