...
def get_layout():
    # Create a layout for the Dash web application
    return html.Div([
        ...
        # Graph to display sentiment data
        dcc.Graph(id="sentiment-graph"),

        # Shared text for all charts
        html.Div([
            html.P(
                "Research Question: Does public sentiment measured by news articles and tweets about a company have any predictive power for stock prices?",
                style={"fontSize": 30}),
            html.P(
                "In this section, I also examined the effect of public sentiment on Nvidia stock."
            ...
            html.P(
                "But the problem is the following: If high expectations are not met,"
