...
def get_layout():
    return html.Div([
        ...
        html.Div([
            ...
            html.P("Brexit Referendum (2016):  The United Kingdoms decision to leave the European Union had a notable impact on both British and European stocks.\
            ...
            html.P("Effect of COVID-19 Lockdowns on Stocks: \
                   The start of the COVID-19 pandemic and subsequent lockdowns in early 2020 had a profound and wide-ranging impact on the stock market. It had by far the biggest effect on the broad market of the events we analyzed.\
