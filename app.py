...
def update_chart(selected_stocks, plot_type, selected_event_date, tab):
    # if tab == 'home':
    ...
    # elif tab == 'sector_performance':
    #     return sector_performance_callbacks.update_chart(selected_stocks, plot_type, selected_event_date)
    # elif tab == 'sector_indicator':
    #     return sector_indicator_callbacks.update_chart(selected_stocks, plot_type, selected_event_date)
    if tab == 'event_analysis':
        return events_callbacks.update_chart(selected_stocks, plot_type, selected_event_date)
    else:
        return {}, "", "", "", ""
